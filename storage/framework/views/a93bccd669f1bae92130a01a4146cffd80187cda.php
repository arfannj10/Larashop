...
<body>
    <nav class="navbar navbar-expand p-0">
        <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-20" href="index.html"> Larashop </a>
        ...
        <div style="min-height: 100%" class="flex-row d-flex align-itemsstretch m-0">
            <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2p-0 collapse d-md-inline" id="sidebar-nav">
                <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
                    ...
                    <li><a href="<?php echo e(route('categories.index')); ?>"><span class="oi oi-tag">
                    </span> Manage categories</a></li>
                    <li><a href="<?php echo e(route('users.index')); ?>"><span class="oi oi-people"></span> Manage Users</a></li>
...
<?php /**PATH H:\P R O J E C T\Laravel\larashop\resources\views/layouts/global.blade.php ENDPATH**/ ?>